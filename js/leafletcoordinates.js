...
L.Control.Coordinates = L.Control.extend({
  ...
  _handleSubmit: function() {
    ...
    if (void 0 !== a && void 0 !== b) {
      var c = this._marker;
      c || (c = this._marker = L.marker(), c.on("click", this._clearMarker, this)), c.setLatLng(new L.LatLng(b, a)), c.addTo(this._map)
    }
  },
  expand: function() {
  ...
  _createCoordinateLabel: function(a) {
    ...
    return b = d.labelFormatterLng ? d.labelFormatterLng(a.lng) : L.Util.template(d.labelTemplateLng, {
  ...
  collapse: function() {
    if (!this._showsCoordinates && (this._map.on("mousemove", this._update, this), this._showsCoordinates = !0, this.options, L.DomEvent.addListener(this._container, "click", this._switchUI, this), L.DomEvent.removeListener(this._container, "mousemove", L.DomEvent.stop), L.DomUtil.addClass(this._inputcontainer, "uiHidden"), L.DomUtil.removeClass(this._labelcontainer, "uiHidden"), this._marker)) {
      var a = L.marker(),
  ...
  toDMS: function(a) {
    var b = Math.floor(a),
        ...
        e = 60 * (c - d),
        f = Math.round(e);
    return 60 == f && (d++, f = "00"), 60 == d && (b++, d = "00"), 10 > f && (f = "0" + f), 10 > d && (d = "0" + d), "" + b + "&deg; " + d + "' " + f + "''"
  },
